...
public class LappamAdapter extends RecyclerView.Adapter<LappamAdapter.ViewHolder> {
    private final List<Lappam> LappamList;
    ...
    public LappamAdapter(List<Lappam> LappamList, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.judul.setText("Laporan Pengamanan Pemungutan Suara di TPS " + tpsList.getNomorTps() + " Desa " +tpsList.getNamaDes());
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Ya, kirim...", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String imageFilePath = getLocalFilePathFromUrl(Lappam.getFoto());
                        ...
                        Call<UpdResponse> call = apiService.uploadFoto(tpsList.getIdTps(), "lappam", Lappam.getSituasi(), Lappam.getPrediksi(), image);
                            ...
                            public void onResponse(Call<UpdResponse> call, Response<UpdResponse> response) {
                                if (response.body() != null) {
                                    ...
                                    if (response.body().getMsg().equals("Upload Berhasil!")) {
                                        updatedb("YES, ALL", v, Lappam.getId_tps());
                                    }else{
    ...
    private void updatedb(String msg, View v, String id_tps) {
        ...
        upd = databaseHelper.updateStatus("lappam", id_tps);
