...
public class CektpsAdapter extends RecyclerView.Adapter<CektpsAdapter.ViewHolder> {
    ...
    public CektpsAdapter(List<CekTps> cektpsList,  Activity activity) {

        this.cektpsList = cektpsList;
        mActivity = activity;
    }
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Ya, kirim...", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String imageFilePath = getLocalFilePathFromUrl(cektps.getFoto());
                        ...
                        Call<UpdResponse> call = apiService.uploadFoto(tpsList.getIdTps(), "cektps", cektps.getSituasi(), cektps.getPrediksi(), image);
                            ...
                            public void onResponse(Call<UpdResponse> call, Response<UpdResponse> response) {
                                if (response.body() != null) {
                                    ...
                                    if (response.body().getMsg().equals("Upload Berhasil!")) {
                                        updatedb("YES, ALL", v, cektps.getId_tps());
                                    }else{
    ...
    private void updatedb(String msg, View v, String id_tps) {
        ...
        upd = databaseHelper.updateStatus("cektps", id_tps);
